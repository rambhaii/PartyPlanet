...
public class FilterTimeSlotAdapter extends RecyclerView.Adapter<FilterTimeSlotAdapter.ViewHolder>
{
    private Context context;
    private List<TimeSlotData> msubslider = new ArrayList<>();
    private int index=-1;

    public FilterTimeSlotAdapter(Context context, List<TimeSlotData> msubslider)
    {
    ...
    @NonNull
    @Override
    public FilterTimeSlotAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position)
    {
        ...
        holder.cardId.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                ((RestaurentFilterActivity) context).getDataAdapter(id);
