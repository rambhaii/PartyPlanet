...
import com.app.partyplanets.LoungeAdapter.LoungAdaptar;
...
public class LoungeBooking extends AppCompatActivity implements View.OnClickListener {
       ...
       LoungAdaptar adapter;
        ...
        protected void onCreate(Bundle savedInstanceState)
        {
            ...
            hotel.setText(" Reserved lounge");

            final Calendar c = Calendar.getInstance();
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N)
            {
                datePicker = new DatePickerDialog(LoungeBooking.this);
            }
            slectdate.setOnClickListener(new View.OnClickListener()
            {
                ...
                public void onClick(View v) {
                    ...
                    DatePickerDialog datePickerDialog = new DatePickerDialog(LoungeBooking.this, new DatePickerDialog.OnDateSetListener() {
                        @Override
...
//                selectedLawn.foodcategoryitems.forEach();
        ...
        private void foodMenulisted(String from)
        {
            ...
            recyclerview.setLayoutManager(new LinearLayoutManager(LoungeBooking.this));
            adapter= new LoungAdaptar(LoungeBooking.this,lawnData);
        ...
        public void onClick(View v)
        {
            ...
            if (v==reserve)
            {
                try {
                    ...
                    {
                        Toast.makeText(LoungeBooking.this, "Please Select from date  ", Toast.LENGTH_SHORT).show();

                    } else if (endDa.isEmpty()) {
                        Toast.makeText(LoungeBooking.this, "Please Select to date  ", Toast.LENGTH_SHORT).show();
                    ...
                    else
                    {
                        ...
                        double price= totalamount * person ;
                       // UtilsMethod.INSTANCE.loungeBookings(LoungeBooking.this,loader,startDate,endDa,guest.getText().toString(),function.getText().toString(),list_id,userId,plateType,moduleId,finalArray);
                       termsAndPolicies(v,startDate,endDa,guest.getText().toString(),function.getText().toString(),list_id,userId,plateType,moduleId,finalArray );
    ...
    public void termsAndPolicies(View v1, String from, String to, String guest, String function_name, String listing_id, String user_id, String plate_type,String module_id,  ArrayList<HashMap<String ,String>>  food_cat_type)
    {
        ...
        okButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                UtilsMethod.INSTANCE.loungeBookings(LoungeBooking.this,loader,from,to,guest,function_name,listing_id,user_id,plate_type,module_id,food_cat_type);
