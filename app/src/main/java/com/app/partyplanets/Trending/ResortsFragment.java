...
public class ResortsFragment extends Fragment {
     ...
     // return inflater.inflate(R.layout.fragment_resorts, container, false);
    ...
    public void GetId(View v)
    {
        ...
        UtilsMethod.INSTANCE.trendingSearch(getActivity(),"3","1");
    }

    @Subscribe
    public void onFragmentActivityMessage(FragmentActivityMessage activityFragmentMessage)
    {
        if (activityFragmentMessage.getMessage().equalsIgnoreCase("diningdata"))
        {
