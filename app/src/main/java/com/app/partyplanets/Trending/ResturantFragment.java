...
public class ResturantFragment extends Fragment { DasboadModel dasboadModel;
    ...
    {
        UtilsMethod.INSTANCE.trendingSearch(getActivity(),"2","1");
    ...
    {
        if (activityFragmentMessage.getMessage().equalsIgnoreCase("restaurantsdata"))
        {
